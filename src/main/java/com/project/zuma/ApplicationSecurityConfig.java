...
//                .antMatchers("/security/user/Edit/**").hasAuthority("ADMIN")
                ...
                .antMatchers("/qa/**").hasAnyAuthority("QA", "ADMIN")
                .antMatchers("/qc/**").hasAnyAuthority("QC", "ADMIN")
                .antMatchers("/canteen/**").hasAnyAuthority("CANTEEN", "ADMIN")
                .antMatchers("/purchase/**").hasAnyAuthority("PURCHASE", "ADMIN")
                .antMatchers("/warehouse/**").hasAnyAuthority("WAREHOUSE", "ADMIN")
                .antMatchers("/accounting/**").hasAnyAuthority("ACCOUNTING", "ADMIN")
                .antMatchers("/production/**").hasAnyAuthority("PRODUCTION", "ADMIN")
                .antMatchers("/engineering/**").hasAnyAuthority("ENGINEERING", "ADMIN")
